...
if "jadwal_gym_rara" not in st.session_state:
    st.session_state.jadwal_gym_rara = {
        ...
        "Hari 5 – Full Lower Body": [{"nama": "Back Squat", "target": "4 × 8"}, {"nama": "Romanian Deadlift", "target": "4 × 8"}, {"nama": "Leg Press", "target": "3 × 12"}, {"nama": "Bulgarian Split Squat", "target": "3 × 10/kaki"}, {"nama": "Leg Extension", "target": "3 × 15"}, {"nama": "Hip Thrust", "target": "4 × 10"}]
    }
